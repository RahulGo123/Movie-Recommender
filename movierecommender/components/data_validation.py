...
from movierecommender.entity.config_entity import DataValidationConfig
...
from movierecommender.constant.training_pipeline import SCHEMA_FILE_PATH
from scipy.stats import ks_2samp
import pandas as pd
import os, sys
from movierecommender.utils.main_utils.utils import read_yaml_file, write_yaml_file
...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            ...
            logging.info(f"Number of columns dataframe has: {len(dataframe.columns)}")
