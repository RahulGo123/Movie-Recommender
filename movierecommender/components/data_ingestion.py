...
from movierecommender.entity.artifact_entity import DataIngestionArtifact
import os
import sys
import pymongo
import numpy as np
...
MONGOO_DB_URL = os.getenv("MONGO_DB_URL")
...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        try:
            ...
            self.mongo_client = pymongo.MongoClient(MONGOO_DB_URL)
            ...
            raise MovieRecommenderException
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        try:
            ...
            logging.info(
                "Exited the split_data_as_train_test method of Data Ingestion class"
            )
            ...
            logging.info("Exported the train and test data to feature store")
